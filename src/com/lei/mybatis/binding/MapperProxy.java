...
public class MapperProxy<T> implements InvocationHandler, Serializable {
    ...
    public Object invoke(Object proxy, Method method, Object[] args)
        ...
        try {
            ...
            /**
             * this step is to determine if the called method belongs to xxxMapper class(interface) or the Object class.
             *
             *
             *example:
             *if the method is xxxMapper.getClass(),what we can expect? the result is a Proxy or a xxxMapper? answer is a Proxy class.
             * */
