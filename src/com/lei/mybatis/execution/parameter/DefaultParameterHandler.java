...
/***
 * @author lei
 * @description tha actual method to execute params into preparedstament when param inputted is a entity instead of primitive variables
 * @param 
 * @param ps
 * @param params
 * @return void
 */
    private void fillParams(PreparedStatement ps,Object[] params) throws Exception {
        ...
        if(null != parameterType && commandType.equals(Constant.SqlType.INSERT )
           ...
           if(params.length == 1){
               ...
               // call helper method  returning  all filed names presenting in sql sentence in order of its first presenting
               List<String> paramNames = getParamNames(commandType, map);

               // get param names by order and return mapping value
     ...
     */
private List<String> getParamNames(Constant.SqlType commandType, HashMap<String,Object> map){
